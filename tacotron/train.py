...
def train(log_dir, args, hparams):
	...
	print('Tacotron training set to a maximum of {} steps'.format(args.tacotron_train_steps))
		...
		try:
			...
			while not coord.should_stop() and step < args.tacotron_train_steps:
				...
				if step % args.eval_interval == 0:
					...
					print('Saving eval log to {}..'.format(eval_dir))
					...
					print('Eval loss for global step {}: {:.3f}'.format(step, eval_loss))
				...
				if step % args.embedding_interval == 0 or step == args.tacotron_train_steps or step == 1:
					...
					print('Tacotron Character embeddings have been updated on tensorboard!')
					log('Tacotron Character embeddings have been updated on tensorboard!')
			

			#print('Tacotron training complete after {} global steps!'.format(args.tacotron_train_steps), slack=True)
