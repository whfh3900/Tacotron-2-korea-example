...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--file_list', type=str, default='korean-single-speaker-speech-dataset/transcript.v.1.1.txt',
                        help='file list to preprocess')
    parser.add_argument('-s', '--silence_mel_padding', type=int, default=100,
                        help='silence audio size is hop_length * silence mel padding')
    parser.add_argument('-p', '--dataset_prefix', type=str, default='korean-single-speaker-speech-dataset/kss/',
